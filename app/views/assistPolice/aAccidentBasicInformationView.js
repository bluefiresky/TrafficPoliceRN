      ...
      <View style={styles.container}>
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={{backgroundColor:'#ffffff',marginTop:15}}>
            ...
            <InputWithIcon labelWidth={20} style={{height: 55, paddingLeft:15}} maxLength={50} icon={require('./image/location.png')} noBorder={true} value={this.state.accidentSite} placeholder={'请填写事故地点'} onChange={this.onChangeText.bind(this)} multiline={true}/>
