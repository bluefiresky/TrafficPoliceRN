...
export function getProvincialData () {
  ...
  {title:'使',isSelcted:false},{title:'WJ',isSelcted:false}];
}
export function getNumberData (){
   ...
   {title:'X',isSelcted:false},{title:'Y',isSelcted:false},{title:'Z',isSelcted:false},{title:'学',isSelcted:false},{title:'警',isSelcted:false},{title:'领',isSelcted:false},{title:'港',isSelcted:false},{title:'澳',isSelcted:false},
   {title:'试',isSelcted:false},{title:'挂',isSelcted:false}];
}
